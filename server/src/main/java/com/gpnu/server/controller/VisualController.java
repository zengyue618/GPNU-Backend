...
import com.gpnu.entity.visual.Dashboard;
...
import com.gpnu.server.service.ChartService;
import com.gpnu.server.service.DashBoardService;
import com.gpnu.server.visual.*;
...
public class VisualController extends BaseController {
    ...
    public Object createDashboard(@RequestBody @OperationObj Dashboard dashboard) {
        dashboard.setCreateTime(Long.parseLong(DateUtil.format(new Date(), "yyMMddHHmm")));
