...
public class LogAspect {
    ...
    private final String operationLogPoint = "@annotation(com.gpnu.server.log.OperationRecord)";
    ...
    public void recordOperation(JoinPoint joinPoint) throws Throwable {
        ...
        operationLog.setCreateTime(Long.parseLong(DateUtil.format(new Date(), "yyMMddHHmm")));
