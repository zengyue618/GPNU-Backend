...
import com.gpnu.server.query.cache.CacheThread;
import com.gpnu.server.query.cache.CacheThreadPool;
import com.gpnu.server.query.cache.DataFrameCache;
import com.gpnu.server.query.dataframe.*;
...
public class JdbcResultSetDataFrameWrapper implements ResultSetDataFrameWrapper<ResultSet> {
    ...
    public DataFrame wrapData(ResultSet result) {
        try {
            ...
            throw new GPNUException("sql exception" + e.getMessage(), ErrorCodes.SYSTEM_EXCEPTION);
        }
    }
